...
![The Overview & Data page on the gapminder panel.](../images/streamlit-overview.png)
...
![The Correlations & Scatter page.](../images/streamlit-correlations.png)

![The Regression page: a native coefficient table with significance stars and fit statistics.](../images/streamlit-regression.png)

## The dataset picker and upload

Launched without data — or deployed to the Cloud — the app starts with a **dataset picker**
(Gapminder / World Bank / Russell 3000) and a file uploader. An uploaded CSV / Excel / Parquet
