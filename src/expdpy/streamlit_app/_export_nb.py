...
def build_export_zip(
    ...
    """Bundle the sample (parquet), its data dictionary (csv), a notebook and a script.

    The data dictionary is always written — taken from ``df_def`` when available, otherwise
    inferred — so the exported notebook can re-attach labels and declare the panel via
